    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Param_Comment', models.TextField(blank=True, verbose_name='Комментарий')),
                ('Name_Variable', models.CharField(max_length=5, verbose_name='Имя переменной')),
                ('Formula', models.TextField(blank=True, verbose_name='Формула для вычисления этого параметра')),
                ('Param_Period', models.DateField(verbose_name='Период сбора данных')),
                ('Param_Value', models.FloatField(blank=True, default=None, null=True, verbose_name='Значение параметра')),
